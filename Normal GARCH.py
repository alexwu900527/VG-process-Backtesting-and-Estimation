...
plt.title(f'{ticker} Normal GARCH {forecast_horizon}-day {float((1-alpha)*100)}% VaR and CVaR Backtesting ({window}-day Rolling Estimation)')
plt.xlabel('Date')
plt.ylabel('Return')
plt.legend()
plt.grid(True)
